 ...
 * @author Pongo
 */
public class WebsiteDeveloper extends Kandidat {

    public WebsiteDeveloper(String nama, String path, int writing, int coding, int interview) {
        super(nama, "Website Developer", writing, coding, interview);
